...
class CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create root comment without nested comments' do
    ...
    assert_difference('PostComment.count', 1) do
      post post_comments_path(@post, @locale), params: { post_comment: comment_attrs }
    end

    new_comment = PostComment.last

    assert_redirected_to post_path(@post, @locale)
  ...
  test 'should create root comment with nested comments' do
    ...
    assert_difference('PostComment.count', 1) do
      post post_comments_path(@post, @locale), params: {
        post_comment: {
